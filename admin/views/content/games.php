...
$categories = $uploadData['categories']['juego'] ?? [];
                                ...
                                <div class="card-footer">
                                    <div class="btn-group btn-group-sm w-100">
                                        ...
                                        <button class="btn btn-danger play-game"
                                            ...
                                            data-extracted="<?php echo $metadata['extracted_path'] ?? ''; ?>"
                                            data-mainfile="<?php echo $metadata['main_file'] ?? 'index.html'; ?>"
...
<script>
    $(document).ready(function() {
        ...
        $('.play-game').click(function() {
            ...
            const extractedPath = $(this).data('extracted');
            const mainFile = $(this).data('mainfile');

            $('#gameTitle').text(gameTitle);

            const gameUrl = '<?php echo SITE_URL; ?>content/' + extractedPath + mainFile;
