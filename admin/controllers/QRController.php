<?php
/**
 * Controlador del Sistema QR
 * Maneja la generación y gestión de códigos QR para buses
 * 
 * Módulos que gestiona:
 * - 3.1: Gestión central de códigos QR
 * - 3.2: Generación de QR personalizados
 * - 3.3: Página de impresión
 * - 3.4: API de generación
 * - 3.5: Configuración WiFi
 */
require_once DIR . '/BaseController.php';
require_once DIR . '/../models/QRCode.php';
require_once DIR . '/../models/Company.php';
